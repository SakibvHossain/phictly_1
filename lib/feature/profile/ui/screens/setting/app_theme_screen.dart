        ...
        child: Column(
          children: [
            ...
            settingActionButtons(
                iconImage: "assets/profile/icons/change_theme.png",
                text: "Change Theme"),
            Divider(
              color: Colors.grey.withValues(alpha: 0.60),
            ),
            settingActionButtons(
                ...
                iconImage: "assets/profile/icons/change_preferred_genre.png",
                text: "Change Preferred Genre"),
            Divider(
              color: Colors.grey.withValues(alpha: 0.60),
            ),
            settingActionButtons(
                iconImage: "assets/profile/icons/text_font_size.png",
                text: "Text Font And Size"),
            Divider(
              color: Colors.grey.withValues(alpha: 0.60),
            ),
            settingActionButtons(
                ...
                iconImage: "assets/profile/icons/profile_private.png",
