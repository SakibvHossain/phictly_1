              ...
              children: [
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Image.asset("assets/icons/home_logo.png",
                                height: 42.93.h, width: 130.96.w),
                            GestureDetector(
                              onTap: () {
                                // action
                              },
                              child: Image.asset("assets/icons/home_search.png",
                ...
                Obx(() {
                  ...
                  return CustomCreatedBookItem(
                    ...
                    author: clubDetail.clubMediumType.contains("BOOK")
                        ? clubDetail.writer
                        : null,
                    ...
                    season: clubDetail.clubMediumType.contains("SHOW")
                        ? clubDetail.totalSeasons.toString()
                        : null,
                    episodes: clubDetail.clubMediumType.contains("SHOW")
                        ? clubDetail.totalEpisodes.toString()
                        : null,
                    ...
                    sliderMaxLength: clubDetail.clubMediumType.contains("BOOK")
                        ? "30"
                        : clubDetail.clubMediumType.contains("MOVIE")
                            ? "9"
                            : "270",
                ...
                const SizedBox(
                    height:
                        70), //* Bottom padding so content doesn't go behind FAB
              ],
            ),
                ...
                onTap: () {
                  ...
                  clubController.clubDetail.value?.clubMediumType
                      ...
                      : clubController.clubDetail.value?.clubMediumType
                                  .contains("MOVIE") ==
                              true
                          ? changeClubController.updateIndex(4)
                          : changeClubController.updateIndex(5);
                },
                child: Image.asset(
