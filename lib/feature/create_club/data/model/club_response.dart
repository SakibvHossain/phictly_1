...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
    ...
    talkPoint: json["talkPoint"] != null
        ? List<DateTime>.from(json["talkPoint"].map((x) => DateTime.parse(x)))
        : [],
    ...
    clubMember: json["clubMember"] != null ? List<dynamic>.from(json["clubMember"]) : [],
...
class PostReadStatus {
  ...
  factory PostReadStatus.fromJson(Map<String, dynamic> json) => PostReadStatus(
